...
public class Video1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String uri ="http://1251542705.vod2.myqcloud.com/4a8d9c67vodtransgzp1251542705/5cd9aacd5285890800089224648/v.f230.ts?start=5384696&end=5764079&type=mpegts";
        videoview.setVideoURI(Uri.parse(uri));
        videoview.start();
        danmakuView = (DanmakuView) findViewById(R.id.danmaku_view1);
        ...
        final LinearLayout operationLayout = (LinearLayout) findViewById(R.id.operation_layout1);
